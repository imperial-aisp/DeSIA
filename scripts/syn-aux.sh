...
do
        python $python_script --aux-type syn --dataset ppmf --filenames ${BLOCKS[@]} --seed $seed --num-aggregates $num_aggregates --test-size $test_size --chosen-gpus 0 --multi-cpus 10 --note $note \
